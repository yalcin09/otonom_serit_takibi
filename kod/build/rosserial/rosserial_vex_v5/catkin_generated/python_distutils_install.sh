...
echo_and_run cd "/home/yalcin/otonom_araba_projesi/src/rosserial/rosserial_vex_v5"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/yalcin/otonom_araba_projesi/src/rosserial/rosserial_vex_v5/setup.py" \
    build --build-base "/home/yalcin/otonom_araba_projesi/build/rosserial/rosserial_vex_v5" \
    install \
    $DESTDIR_ARG \
